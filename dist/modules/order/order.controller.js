...
class ExamplesController {
    ...
    list(response, request) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const data = yield order_schema_1.TodoModel.create({ description });
            console.log(data);
...
], ExamplesController.prototype, "list", null);
ExamplesController = __decorate([
    routing_controllers_1.JsonController('/api/order')
    // @Controller()
    ,
